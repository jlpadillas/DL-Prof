...
def run(flags_obj, datasets_override=None, strategy_override=None):
  ...
  events_file = CFG_DIR / "events_mnist.cfg"
...
#      MeasureOnEachEpoch(lib_path=str(libname),
      MeasureOnEachBatch(lib_path=str(libname),
...
def define_mnist_flags(batch_size):
  ...
  FLAGS.set_default('batch_size', batch_size)

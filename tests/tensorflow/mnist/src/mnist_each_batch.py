...
if __name__ == "__main__":
    ...
    train_output_file = "out/mnist_train_each_batch.csv"
    test_output_file = "out/mnist_test_each_batch.csv"
    predict_output_file = "out/mnist_predict_each_batch.csv"
    ...
    my_callbacks = MeasureOnEachBatch(lib_path=str(libname),
